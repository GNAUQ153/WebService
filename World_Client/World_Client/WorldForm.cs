...
namespace World_Client
{
    public partial class WorldForm : Form
    {
        ...
        public static HttpWebRequest CreateSOAPWebRequest(string operation)
            {
            HttpWebRequest req = (HttpWebRequest)WebRequest.Create(@"https://localhost:44338/API/WorldWS.asmx");
        ...
        private void WorldForm_Load(object sender, EventArgs e)
            ...
            dgvInfo.ColumnCount = 5;
            dgvInfo.Columns[0].Name = "ID";
            dgvInfo.Columns[1].Name = "Name";
            dgvInfo.Columns[2].Name = "Country Code";
            dgvInfo.Columns[3].Name = "District";
            dgvInfo.Columns[4].Name = "Population";
            }
